...
| Número | Perguntas | Opções de resposta |
| --- | --- | --- |
| 1 | Você consegue se imaginar utilizando o sistema com base no storyboard? | [ ]Sim <br>[ ]Não |
| 2 | Existe alguma parte do storyboard que você considera confusa ou difícil de entender? Qual? | Aberta |
| 3 | O storyboard representa de maneira adequada as atividades que o ator realiza no sistema?  | [ ]Sim <br>[ ]Não |
| 4 | Você acha que o ator realizou a principal tarefa proposta do Storyboard?  | [ ]Sim <br>[ ]Não |
...
<div style="text-align: center">
<p> Figura 2: Storyboard buscar locais turísticos <br/>(Fonte: Guilherme, 2023).</p>
</div>
