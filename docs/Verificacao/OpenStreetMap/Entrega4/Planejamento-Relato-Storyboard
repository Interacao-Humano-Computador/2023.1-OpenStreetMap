...
| 9  | Foi apresentado a importância dos participantes assinarem o termo de consentimento? | Sim |  |
...
<img src="../../OpenStreetMap/assets/img/RelatoResulStoryboard.PNG"></img>
